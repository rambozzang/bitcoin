...
class UpbitInfoViewbak extends StatefulWidget {
  const UpbitInfoViewbak({Key? key}) : super(key: key);

  @override
  State<UpbitInfoViewbak> createState() => _UpbitInfoViewbakState();
}

class _UpbitInfoViewbakState extends State<UpbitInfoViewbak> {
